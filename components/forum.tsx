...
import { MessageSquare, Plus, Pin, ThumbsUp, MessageCircle, Clock, Users } from "lucide-react"
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Thảo luận và hỗ trợ lẫn nhau trong hành trình cai thuốc</p>
        </div>
                ...
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <h3 className="font-medium text-gray-900 hover:text-blue-600 mb-1">{topic.title}</h3>
