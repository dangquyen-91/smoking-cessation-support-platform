            ...
            <CardContent className="p-4">
              <div className="flex flex-wrap gap-2">
                {categories.map((category, index) => (
                  <Badge key={index} variant={category.active ? "default" : "secondary"} className="cursor-pointer">
        ...
        <div className="space-y-6">
              ...
              <div className="space-y-3">
                {popularPosts.map((post, index) => (
                  <div key={index} className="p-3 border rounded-lg hover:bg-gray-50 cursor-pointer">
                    ...
                    <p className="text-xs text-gray-600">{post.views} lượt xem</p>
                  </div>
                ))}
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Nhận bài viết mới nhất qua email</CardDescription>
            </CardHeader>
            <CardContent>
