...
export function Dashboard() {
  ...
  const achievements = [
    ...
    {
      title: "Hai tuần mạnh mẽ",
      description: "14 ngày không hút thuốc",
      completed: true,
    },
    {
      title: "Một tháng chiến thắng",
      description: "30 ngày không hút thuốc",
      completed: false,
    },
  ];
      ...
      >
        <div className="bg-gradient-to-r from-green-500 to-blue-600 text-white p-6 rounded-lg">
          ...
          <p className="text-green-100">
            Hôm nay là ngày thứ {stats.smokeFreedays} bạn không hút thuốc. Tuyệt
            vời!
          </p>
        </div>
      </motion.section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Theo dõi mục tiêu hàng ngày của bạn
              </CardDescription>
            </CardHeader>
