  ...
  const tools = [
    {
      ...
      description: "Kiểm tra mức độ phụ thuộc nicotine của bạn",
      icon: Heart,
      color: "text-red-600",
      bgColor: "bg-red-50",
      onClick: onUseAddictionTool,
    },
    {
      title: "Tính chi phí hút thuốc",
      description: "Xem bạn đã chi bao nhiêu tiền cho thuốc lá",
      icon: Calculator,
      color: "text-blue-600",
      bgColor: "bg-blue-50",
      onClick: onUseCostTool,
    },
    {
      title: "Tài liệu hướng dẫn",
      description: "Các bài viết và video hướng dẫn cai thuốc",
      icon: FileText,
  ...
  const packages = [
    {
      name: "Miễn phí",
      price: "0đ",
      features: ["Theo dõi cơ bản", "Cộng đồng", "Blog & Forum"],
      popular: false,
    },
    {
      name: "Premium",
      price: "299,000đ/tháng",
      features: ["Chat với coach", "A.I. tư vấn", "Báo cáo chi tiết"],
      popular: true,
    },
    {
      name: "VIP",
      price: "599,000đ/tháng",
      features: ["Video call", "Coach riêng", "Tư vấn chuyên sâu"],
      popular: false,
    },
  ]
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" onClick={onUseAddictionTool}>
      ...
      <section className="py-16 bg-gray-50 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={onViewBlog}>
              <CardContent className="p-6">
            ...
            <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={onViewForum}>
              <CardContent className="p-6">
                <div className="flex items-center gap-4 mb-4">
