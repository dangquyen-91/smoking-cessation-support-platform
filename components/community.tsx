...
import { Users, Trophy, Heart, MessageCircle, Share2, ThumbsUp } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Chia sẻ thành tích và tương tác với cộng đồng</p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Những thành tích được chia sẻ gần đây</CardDescription>
            </CardHeader>
              ...
              {achievements.map((achievement, index) => (
                <div key={index} className="p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="flex items-start gap-3">
                    <Avatar>
                      <AvatarImage src={achievement.avatar || "/placeholder.svg"} />
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700 mb-3">{achievement.achievement}</p>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Khuyến khích cộng đồng bằng cách chia sẻ tiến trình</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {topMembers.map((member, index) => (
                  <div key={index} className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-gray-600">{member.days} ngày</div>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="text-center p-4 bg-green-50 rounded-lg">
                ...
                <div className="text-sm text-green-700">Thành viên tích cực</div>
              </div>
              <div className="text-center p-4 bg-blue-50 rounded-lg">
                <div className="text-2xl font-bold text-blue-600">15,680</div>
                <div className="text-sm text-blue-700">Ngày không hút thuốc</div>
              </div>
